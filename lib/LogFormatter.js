...
class LogFormatter {
  ...
  format(level, message, metadata = {}) {
    ...
    const baseLog = {
      ...
      msg: formattedMessage, // Add msg field for SAP BTP Cloud Logging filtering
    ...
    if (this.config.enableSAPFieldMapping !== false) {
      this._applySAPFieldMapping(baseLog);
    }
   ...
   * @private
   */
  _applySAPFieldMapping(logEntry) {
    // Map internal fields to Cloud Logging Standard Fields
